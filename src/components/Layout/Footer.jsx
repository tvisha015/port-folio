      ...
      <div className="mx-auto max-w-6xl items-center justify-between px-4 md:flex lg:px-0">
        <div className="inline-flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
            ...
            <image href="D:\collage\react-tailwind-css-starter-pack-main\Portfolio\src\assets\logos\Edaxu.jpg" width="20" height="20" x="10" y="10" />
        ...
        <span className="ml-4 text-lg font-bold">Eduax</span>
      </div>
      <div className="mt-4 md:mt-0">
        <p className="text-sm font-medium text-gray-500">© 2024 Eduax. All rights reserved.</p>
      </div>
    </div>
  </footer >
  );
